...
export function BlockingToast({ isOpen, title, message, type, onClose }: BlockingToastProps) {

    // Auto-close success after 3 seconds if no manual close provided
    useEffect(() => {
        if (isOpen && type === 'success' && onClose) {
